-- greetz to henry
-- https://github.com/henrybatt/neovim-config/blob/refactor/lua/plugins/picker.lua
return {
    "folke/snacks.nvim",
    priority = 1000,
    lazy = false,
    ...
    keys = {
        ...
        },
        {
            "<leader>sg",
            function()
                Snacks.picker.grep({ hidden = true, ignored = true, exclude = { "build/**", "*.json", "target/**", "install/**" } })
            end,
            desc = "Grep",
        },
        {
